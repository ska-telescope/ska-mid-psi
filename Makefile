...
OET_URL ?= 142.73.34.170/$(KUBE_NAMESPACE)/oet/api/v8
ODA_URL ?= 142.73.34.170/$(KUBE_NAMESPACE)/oda/api/v8
SLT_SERVICES_URL ?= 142.73.34.170/$(KUBE_NAMESPACE)/slt/api/v0
PTT_SERVICES_URL ?= 142.73.34.170/$(KUBE_NAMESPACE)/ptt/api/v0
