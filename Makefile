...
ifeq ($(DISH_LMC_ENABLED),true)
	ifeq ($(SPFRX_ENABLED),true)
		...
		K8S_CHART_PARAMS += --set spfrx.enabled=false ska-dish-lmc.ska-mid-dish-simulators.deviceServers.spfrxdevice.enabled=true -f charts/ska-mid-psi/tmc-4-dish-lmc-values.yaml
	endif
