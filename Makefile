...
K8S_CHART_PARAMS = --set global.minikube=$(MINIKUBE) \
	...
	--set ska-mid-dish-manager.ska-mid-dish-ds-manager.dishstructuremanager.dsc.fqdns={$(TANGO_HOSTNAME).$(KUBE_NAMESPACE).svc.$(CLUSTER_DOMAIN)/mid-dish/ds-manager/SKAska001}
	$(TARANTA_PARAMS)
